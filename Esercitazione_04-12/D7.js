...
function cooncatString(str1, str2) {
  ...
  let sliceString2 = str2.slice(str2.length - 3, str2.length);
  console.log(sliceString2);
  console.log(sliceString1.concat(sliceString2).toUpperCase());
}

cooncatString("ciao", "bello");
...
console.log(newArrMap(exerciseArr, 3));
...
var newStringNum = [];
var stringLength = stringArr.forEach(element => {
  newStringNum.push(element.length);
})
